    ...
    <article className="post">
      ...
      <div className="post__actions">
        <button
          ...
          aria-label={`${liked ? 'Retirer' : 'Ajouter'} un like`}
          aria-pressed={liked}
          tabIndex={0}
        >
          <svg width="13" height="13" viewBox="0 0 16 16" fill={liked ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
        ...
        <button
          ...
          aria-label={`${expanded ? 'Masquer' : 'Afficher'} les commentaires`}
      ...
      {expanded && (
        <div className="post__comments" role="region" aria-label="Commentaires">
